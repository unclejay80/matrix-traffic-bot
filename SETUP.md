...
You'll notice that "traffic-bot" is scattered throughout the codebase. When
it comes time to modifying the code for your own purposes, you are expected to
replace every instance of "traffic-bot" and its variances with your own
project's name.
